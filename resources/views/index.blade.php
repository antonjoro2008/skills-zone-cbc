...
@section('content')
    ...
    <section id="landing" class="page-section">
        ...
        <div class="gradient-bg text-white overflow-hidden relative">
            ...
            <div class="absolute top-40 right-20 w-16 h-16 bg-white bg-opacity-10 rounded-full animate-float"
                style="animation-delay: 1s;"></div>
            <div class="absolute bottom-20 left-1/4 w-12 h-12 bg-white bg-opacity-10 rounded-full animate-float"
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="text-center lg:text-left animate-fade-in-left">
                        ...
                        <p class="text-xl md:text-2xl mb-8 max-w-2xl mx-auto lg:mx-0 text-gray-100 leading-relaxed">
                            Affordable, token-based assessments for CBC Based learners. Build skills, track progress, and
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            ...
                            <button id="joinFreeBtn"
                                class="group border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-gray-900 px-8 py-4 rounded-full text-lg font-semibold transition-all hover:scale-105 hover:-translate-y-1 shadow-lg"
                    ...
                    <div class="hidden lg:block animate-fade-in-right">
                        <div class="relative">
                            <div
                                class="bg-white bg-opacity-10 backdrop-blur-sm rounded-3xl p-8 transform rotate-6 hover:rotate-3 transition-transform duration-500">
                                <div class="bg-gradient-to-br from-[#8FC340] to-[#E368A7] rounded-2xl p-6 mb-4">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <span
                                            class="bg-white text-[#8FC340] px-3 py-1 rounded-full text-sm font-bold">85%</span>
                                    </div>
        ...
        <div class="py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 relative z-10">
                <div class="text-center mb-16">
                    <div
                        class="inline-flex items-center bg-blue-500/20 backdrop-blur-sm rounded-full px-6 py-3 mb-6 border border-blue-400/30">
                    ...
                    <h2 class="text-4xl md:text-4xl font-bold text-white mb-6">
                        How to Navigate
                        <span class="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Gravity CBC
                            Assessments Portal</span>
                    </h2>
                    <p class="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                        Watch this quick guide to learn how to get started with assessments, purchase tokens, and track your
                        progress.
                    </p>
                </div>
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="relative bg-black rounded-3xl overflow-hidden shadow-2xl border border-gray-700">
                        ...
                        <div id="videoPlaceholder"
                            class="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                            <div class="text-center">
                                <div
                                    class="w-20 h-20 bg-blue-500/20 rounded-full flex items-center justify-center mb-4 mx-auto animate-pulse">
                        ...
                        <!-- Video Element -->
                        <video id="navigationVideo" class="w-full h-full object-cover hidden" preload="metadata" controls
                            playsinline webkit-playsinline>
                            <source src="/videos/navigation-guide.mp4" type="video/mp4">
                            <p class="text-white p-8 text-center">
                                Your browser doesn't support HTML5 video.
                                <a href="/videos/navigation-guide.mp4" class="text-blue-400 underline">Download the
                                    video</a> instead.
                            </p>
                        </video>
                        ...
                        <!-- Custom Play Button -->
                        <div id="playButton"
                            class="absolute inset-0 flex items-center justify-center bg-black/30 backdrop-blur-sm cursor-pointer group transition-all duration-300 hover:bg-black/20">
                            <div
                                class="w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-2xl">
                        ...
                        <div id="videoControls" class="absolute bottom-4 left-4 right-4 hidden">
                            <div
                                class="flex items-center justify-between bg-black/50 backdrop-blur-sm rounded-lg px-4 py-2">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 relative z-10">
                <div class="text-center mb-20">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Features that make us
                        <span
                            class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">extraordinary</span>
                    </h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">Discover the affordable, accessible features that
                        make us the leading assessment platform for Competency Based Curriculum Based Curriculum learners
                        practicing with us</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div
                        class="group bg-white rounded-3xl p-8 shadow-lg card-hover border border-gray-100 hover:border-blue-200">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform">
                            <i class="fas fa-brain"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-4 text-gray-900 group-hover:text-blue-600 transition-colors">
                            Token-Based Access</h3>
                        <p class="text-gray-600 leading-relaxed">Pay only for what you use with our flexible token system.
                            No monthly fees, just affordable per-assessment pricing.</p>
                        <div
                            class="mt-6 text-blue-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                            <a href="{{ route('pricing') }}">Learn more →</a>
                        </div>
                    </div>

                    <div
                        class="group bg-white rounded-3xl p-8 shadow-lg card-hover border border-gray-100 hover:border-green-200">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform">
                            <i class="fas fa-certificate"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-4 text-gray-900 group-hover:text-green-600 transition-colors">
                            Affordable Learning</h3>
                        <p class="text-gray-600 leading-relaxed">Designed for CBC Based learners with competitive pricing
                            and flexible payment options.</p>
                        <div
                            class="mt-6 text-green-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                            <a href="{{ route('subjects') }}">View certificates →</a>
                        </div>
                    </div>

                    <div
                        class="group bg-white rounded-3xl p-8 shadow-lg card-hover border border-gray-100 hover:border-purple-200">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform">
                            <i class="fas fa-chart-line"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-4 text-gray-900 group-hover:text-purple-600 transition-colors">
                            Progress Tracking</h3>
                        <p class="text-gray-600 leading-relaxed">Detailed analytics and progress reports help you identify
                            strengths and areas for improvement.</p>
                        <div
                            class="mt-6 text-purple-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                            <a href="{{ route('dashboard') }}">See analytics →</a>
                        </div>
                    </div>

                    <div
                        class="group bg-white rounded-3xl p-8 shadow-lg card-hover border border-gray-100 hover:border-orange-200">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform">
                            <i class="fas fa-mobile-alt"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-4 text-gray-900 group-hover:text-orange-600 transition-colors">
                            Mobile Friendly</h3>
                        <p class="text-gray-600 leading-relaxed">Take assessments anywhere, anytime on any device with our
                            responsive platform.</p>
                        <div
                            class="mt-6 text-orange-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                            <a href="{{ route('subjects') }}">Try mobile →</a>
                        </div>
                    </div>

                    <div
                        class="group bg-white rounded-3xl p-8 shadow-lg card-hover border border-gray-100 hover:border-red-200">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform">
                            <i class="fas fa-shield-alt"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-4 text-gray-900 group-hover:text-red-600 transition-colors">Secure &
                            Reliable</h3>
                        <p class="text-gray-600 leading-relaxed">Bank-level security ensures your data and assessment
                            results are always protected.</p>
                        <div
                            class="mt-6 text-red-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                            <a href="{{ route('privacy') }}">Security details →</a>
                        </div>
                    </div>

                    <div
                        class="group bg-white rounded-3xl p-8 shadow-lg card-hover border border-gray-100 hover:border-teal-200">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform">
                            <i class="fas fa-users"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-4 text-gray-900 group-hover:text-teal-600 transition-colors">Expert
                            Support</h3>
                        <p class="text-gray-600 leading-relaxed">Get help from our team of assessment experts and career
                            counselors.</p>
                        <div
                            class="mt-6 text-teal-600 font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div class="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 py-20 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 relative z-10">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Trusted by education actors in the country
                    </h2>
                    <p class="text-blue-200 text-lg">Join thousands of learners across the country who practice with Gravity
                        CBC Assessments</p>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div class="stat-counter rounded-2xl p-6 text-center group hover:scale-105 transition-all duration-300">
                        <div
                            class="text-4xl md:text-5xl font-bold text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text mb-2 group-hover:scale-110 transition-transform">
                            95%
                        </div>
                    ...
                    <div class="stat-counter rounded-2xl p-6 text-center group hover:scale-105 transition-all duration-300">
                        <div
                            class="text-4xl md:text-5xl font-bold text-transparent bg-gradient-to-r from-red-400 to-yellow-400 bg-clip-text mb-2 group-hover:scale-110 transition-transform">
                            24/7
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (muteBtn) {
                muteBtn.addEventListener('click', function () {
                    ...
                    if (icon) {
                        icon.className = video.muted ? 'fas fa-volume-mute text-lg' :
                            'fas fa-volume-up text-lg';
                    }
                });
            }
