...
<nav class="fixed top-0 w-full z-50 glass-effect">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
                <!-- <a href="{{ route('home') }}" class="text-2xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-pulse-glow"> -->
            ...
            <div class="hidden md:flex items-center space-x-4">
                <button class="bg-white text-blue-600 border-2 border-blue-600 hover:bg-blue-50 px-6 py-2 rounded-full text-sm font-medium transition-all hover:scale-105" onclick="showModal('loginModal')" id="loginBtn">
                    <i class="fas fa-sign-in-alt mr-2"></i>Login
                </button>
                <button class="bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 px-6 py-2 rounded-full text-sm font-medium transition-all shadow-lg hover:shadow-xl hover:scale-105" onclick="showModal('registerModal')" id="registerBtn">
    ...
    <div id="mobileMenu" class="mobile-menu md:hidden fixed top-16 left-0 w-full h-screen bg-white z-40">
        <div class="p-6 space-y-4">
            ...
            <a href="{{ route('transactions') }}" class="block text-lg font-medium text-gray-700 hover:text-blue-600 py-2 {{ request()->routeIs('transactions') ? 'text-blue-600 font-semibold' : '' }}" id="transactionsLinkMobile" style="display:none;">Purchases</a>
            <div class="pt-4 border-t border-gray-200 space-y-3">
                <button class="w-full bg-white text-blue-600 border-2 border-blue-600 hover:bg-blue-50 px-6 py-3 rounded-full font-medium transition-all" onclick="showModal('loginModal'); toggleMobileMenu()" id="loginBtnMobile">
                    <i class="fas fa-sign-in-alt mr-2"></i>Login
                </button>
                <button class="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 px-6 py-3 rounded-full font-medium transition-all shadow-lg" onclick="showModal('registerModal'); toggleMobileMenu()" id="registerBtnMobile">
                    <i class="fas fa-rocket mr-2"></i>Get Started
                </button>
